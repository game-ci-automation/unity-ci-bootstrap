 ...
 */
async function createNetworkResources(networkClient, resourceGroupName, location, vmName, vnet) {
...
export async function provisionVM(vmId, subscriptionId) {
    ...
    try {
        ...
        const { nic, publicIP } = await createNetworkResources(networkClient, resourceGroupName, location, vmName, vnet);
